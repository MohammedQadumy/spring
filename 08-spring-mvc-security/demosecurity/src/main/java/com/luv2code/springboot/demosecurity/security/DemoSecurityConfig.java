...
public class DemoSecurityConfig {
    ...
    // this function is the answer in properties file , the users before were hardcoded
    @Bean
    ...
    public InMemoryUserDetailsManager userDetailsManager(){
        ...
        UserDetails mary = User.builder().username("mary").
                password("{noop}test123").roles("MANAGER","EMPLOYEE").build();

        UserDetails susan = User.builder().username("susan").
                password("{noop}test123").roles("Admin","MANAGER","EMPLOYEE").build();
